using Application.Features.Commands.Entry.CreateFav;
using Application.Features.Commands.Entry.DeleteFav;
using Application.Features.Commands.EntryComment.CreateFav;
using Application.Features.Commands.EntryComment.DeleteFav;
using MediatR;
